...
public class Utility {
	...
	public static void send(String toEmail, String subject, String body) {
		final String fromEmail = "earthjain143@gmail.com"; // requires valid gmail id
		final String password = "avanikale143"; // correct password for gmail id
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("earthjain143@gmail.com", false));
	...
	public static String getUrl(Long id) {
		...
		return "http://localhost:9091/user/" + tokenUtil.createToken(id);
	}
	...
	public static String sendEmail(EmailId emailId) {
		final String fromEmail = "earthjain143@gmail.com"; // requires valid gmail id
		final String password = "avanikale143"; // correct password for gmail id
		Properties props = new Properties();
		props.put("mail.smtp.host", "smtp.gmail.com"); // SMTP Host
